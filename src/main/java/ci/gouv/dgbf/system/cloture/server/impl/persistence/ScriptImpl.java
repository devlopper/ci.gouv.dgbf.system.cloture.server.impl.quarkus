...
@NamedStoredProcedureQueries(value = {
	@NamedStoredProcedureQuery(
		name = ScriptImpl.STORED_PROCEDURE_QUERY_PROCEDURE_NAME_EXECUTE_PROCEDURE
		,procedureName = ScriptImpl.STORED_PROCEDURE_QUERY_PROCEDURE_NAME_EXECUTE_PROCEDURE
		,parameters = {
...
public class ScriptImpl extends AbstractIdentifiableSystemScalarStringIdentifiableBusinessStringNamableImpl implements Script,Serializable {
	...
	@Override
	public ScriptImpl setIdentifier(String identifier) {
		return (ScriptImpl) super.setIdentifier(identifier);
	}
	
	@Override
	public ScriptImpl setCode(String code) {
		return (ScriptImpl) super.setCode(code);
	}
	
	@Override
	public ScriptImpl setName(String name) {
		return (ScriptImpl) super.setName(name);
	}
	
	@Override
	public Script setGroup(Script group) {
	...
	public static final String ENTITY_NAME = "ScriptImpl";
	public static final String TABLE_NAME = "TA_PROCEDURE";
