...
INSERT INTO TA_OPERATION(IDENTIFIANT,CODE,LIBELLE,GROUPE,DATE_DEBUT,PROCEDURE_LIBELLE,EXECUTION_STATUS) VALUES ('V01','V01','Verrouillage des engagements par bon de commande dont l''ordonnateur n''a pas fait la 1ere validation','E',DATE '2021-11-1','P','EXECUTEE');
