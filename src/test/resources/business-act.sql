...
INSERT INTO TA_ACTE_OPERATION (IDENTIFIANT,ACTE,OPERATION,OPERATION_DATE,DECLENCHEUR) VALUES ('1','locked01','VERROUILLAGE',DATE '2000-1-1','test');
INSERT INTO VMA_ACTE (IDENTIFIANT,CODE,LIBELLE) VALUES ('locked02','locked02','1');
INSERT INTO TA_ACTE_OPERATION (IDENTIFIANT,ACTE,OPERATION,OPERATION_DATE,DECLENCHEUR) VALUES ('2','locked02','VERROUILLAGE',DATE '2000-1-1','test');
INSERT INTO VMA_ACTE (IDENTIFIANT,CODE,LIBELLE) VALUES ('unlocked01','unlocked01','1');
INSERT INTO TA_ACTE_OPERATION (IDENTIFIANT,ACTE,OPERATION,OPERATION_DATE,DECLENCHEUR) VALUES ('3','unlocked01','DEVERROUILLAGE',DATE '2000-1-1','test');
INSERT INTO VMA_ACTE (IDENTIFIANT,CODE,LIBELLE) VALUES ('unlocked02','unlocked02','1');
INSERT INTO TA_ACTE_OPERATION (IDENTIFIANT,ACTE,OPERATION,OPERATION_DATE,DECLENCHEUR) VALUES ('4','unlocked02','DEVERROUILLAGE',DATE '2000-1-1','test');